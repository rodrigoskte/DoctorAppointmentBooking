        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimeSchedule = table.Column<DateTime>(type: "datetime", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Schedule",
                columns: new[] { "Id", "DateTimeSchedule", "DoctorId", "IsDeleted", "PatientId" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Local), 1, false, 1 },
                    { 2, new DateTime(2024, 6, 28, 0, 0, 0, 0, DateTimeKind.Local), 2, false, 2 },
                    { 3, new DateTime(2024, 6, 20, 0, 0, 0, 0, DateTimeKind.Local), 3, false, 3 },
                    { 4, new DateTime(2024, 6, 19, 0, 0, 0, 0, DateTimeKind.Local), 2, false, 2 },
                    { 5, new DateTime(2024, 6, 12, 0, 0, 0, 0, DateTimeKind.Local), 3, false, 3 },
                    { 6, new DateTime(2024, 6, 14, 0, 0, 0, 0, DateTimeKind.Local), 1, false, 1 }
                });
